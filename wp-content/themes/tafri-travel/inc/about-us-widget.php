...
class Tafri_Travel_Widget_About_Us extends WP_Widget {
	...
	public function form( $instance ) {
		...
		?>
		<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'upload_image' ) ); ?>" name="<?php echo esc_attr($this->get_field_name( 'upload_image' )); ?>" type="text" value="<?php echo esc_url( $instance['upload_image'] ); ?>" />
	   	</p>
		<?php 
	}
